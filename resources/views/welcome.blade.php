    ...
    <section class="relative min-h-[90vh] lg:min-h-screen pt-28 pb-12 flex items-center overflow-hidden hero-mesh">
        <div class="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 lg:gap-16 items-center w-full">
            <div class="z-10 text-center lg:text-left">
                <div class="reveal inline-flex items-center gap-2 px-6 pt-4 pb-3 rounded-full bg-orange-50 text-orange-600 text-xs font-bold uppercase tracking-wider leading-normal mb-12 md:mb-16 border border-orange-100">
                    <span class="w-2 h-2 rounded-full bg-orange-500 animate-pulse"></span>
                    ચકાસાયેલ શૈક્ષણિક પ્લેટફોર્મ
                </div>
                <h1 class="reveal text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-black tracking-normal leading-snug">
                    <span class="block mb-6 sm:mb-8 md:mb-10 pt-2">માતૃભાષામાં</span>
                    <span class="block mb-6 sm:mb-8 md:mb-10 pt-2 text-gradient">શક્તિશાળી</span>
                    <span class="block pt-2">શિક્ષણ.</span>
                </h1>
